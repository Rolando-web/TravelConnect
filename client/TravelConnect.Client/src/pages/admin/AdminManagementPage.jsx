...
{ key: "email", label: "Email", required: true, type: "email" },
  ...
  flights: {
    ...
    fields: [
      ...
      { key: "seatsAvailable", label: "Seats Available", type: "number", min: 0 },
  ...
  hotels: {
    ...
    fields: [
      ...
      { key: "pricePerNight", label: "Price/Night (₱)", type: "number", min: 0 },
  ...
  cars: {
    ...
    fields: [
      ...
      { key: "location", label: "Location", required: true },
      { key: "pricePerDay", label: "Price/Day (₱)", type: "number", min: 0 },
