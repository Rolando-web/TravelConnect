...
{
    [HttpGet]
    public async Task<ActionResult<IEnumerable<SystemUser>>> GetAll()
    {
    ...
    [HttpGet("{id:int}")]
    public async Task<ActionResult<SystemUser>> GetById(int id)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<SystemUser>> Create(SystemUser entity)
    {
