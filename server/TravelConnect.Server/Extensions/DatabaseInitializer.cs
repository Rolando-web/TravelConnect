...
public static class DatabaseInitializer
{
    ...
    private static async Task SeedAsync(TravelConnectDbContext db)
    {
        ...
        if (!await db.Flights.AnyAsync())
        {
            ...
            {
                new Flight { Airline = "Philippine Airlines", FlightNumber = "PR 102", DepartureCity = "Manila", ArrivalCity = "Cebu", DepartureTime = "07:00", ArrivalTime = "08:15", DepartureDate = flightDate(7), Price = 4200m, Class = "Economy", SeatsAvailable = 120, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Cebu Pacific", FlightNumber = "5J 501", DepartureCity = "Manila", ArrivalCity = "Boracay", DepartureTime = "09:30", ArrivalTime = "10:40", DepartureDate = flightDate(8), Price = 3800m, Class = "Economy", SeatsAvailable = 150, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                new Flight { Airline = "PAL Express", FlightNumber = "2P 210", DepartureCity = "Manila", ArrivalCity = "Puerto Princesa", DepartureTime = "11:00", ArrivalTime = "12:30", DepartureDate = flightDate(9), Price = 4600m, Class = "Economy", SeatsAvailable = 130, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "ANA", FlightNumber = "NH 818", DepartureCity = "Manila", ArrivalCity = "Tokyo", DepartureTime = "20:15", ArrivalTime = "02:00", DepartureDate = flightDate(10), Price = 28500m, Class = "Economy", SeatsAvailable = 90, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Japan Airlines", FlightNumber = "JL 742", DepartureCity = "Manila", ArrivalCity = "Osaka", DepartureTime = "13:30", ArrivalTime = "21:00", DepartureDate = flightDate(11), Price = 31000m, Class = "Economy", SeatsAvailable = 110, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Singapore Airlines", FlightNumber = "SQ 921", DepartureCity = "Manila", ArrivalCity = "Singapore", DepartureTime = "16:00", ArrivalTime = "19:45", DepartureDate = flightDate(12), Price = 24000m, Class = "Business", SeatsAvailable = 45, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Emirates", FlightNumber = "EK 335", DepartureCity = "Manila", ArrivalCity = "Dubai", DepartureTime = "22:45", ArrivalTime = "04:30", DepartureDate = flightDate(13), Price = 46000m, Class = "Economy", SeatsAvailable = 150, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                new Flight { Airline = "KLM", FlightNumber = "KL 806", DepartureCity = "Manila", ArrivalCity = "Amsterdam", DepartureTime = "01:30", ArrivalTime = "09:15", DepartureDate = flightDate(14), Price = 58000m, Class = "Economy", SeatsAvailable = 160, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Qantas", FlightNumber = "QF 20", DepartureCity = "Manila", ArrivalCity = "Sydney", DepartureTime = "08:45", ArrivalTime = "19:30", DepartureDate = flightDate(15), Price = 52000m, Class = "Economy", SeatsAvailable = 140, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Delta", FlightNumber = "DL 440", DepartureCity = "Manila", ArrivalCity = "New York", DepartureTime = "23:55", ArrivalTime = "11:00", DepartureDate = flightDate(16), Price = 82000m, Class = "Business", SeatsAvailable = 40, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                // ── Affordable Manila-origin routes for the budget flight combos ──
                new Flight { Airline = "Cebu Pacific", FlightNumber = "5J 585", DepartureCity = "Manila", ArrivalCity = "Cebu", DepartureTime = "06:30", ArrivalTime = "07:45", DepartureDate = flightDate(17), Price = 2900m, Class = "Economy", SeatsAvailable = 140, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Air Swift", FlightNumber = "DG 712", DepartureCity = "Manila", ArrivalCity = "Siargao", DepartureTime = "10:00", ArrivalTime = "11:40", DepartureDate = flightDate(18), Price = 5200m, Class = "Economy", SeatsAvailable = 72, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Air Swift", FlightNumber = "DG 624", DepartureCity = "Manila", ArrivalCity = "El Nido", DepartureTime = "08:15", ArrivalTime = "09:45", DepartureDate = flightDate(19), Price = 6300m, Class = "Economy", SeatsAvailable = 60, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Scoot", FlightNumber = "TR 395", DepartureCity = "Manila", ArrivalCity = "Singapore", DepartureTime = "12:10", ArrivalTime = "15:40", DepartureDate = flightDate(20), Price = 8900m, Class = "Economy", SeatsAvailable = 130, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Thai Airways", FlightNumber = "TG 621", DepartureCity = "Manila", ArrivalCity = "Bangkok", DepartureTime = "21:30", ArrivalTime = "23:50", DepartureDate = flightDate(21), Price = 8200m, Class = "Economy", SeatsAvailable = 120, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "EVA Air", FlightNumber = "BR 272", DepartureCity = "Manila", ArrivalCity = "Taipei", DepartureTime = "14:05", ArrivalTime = "16:20", DepartureDate = flightDate(22), Price = 7800m, Class = "Economy", SeatsAvailable = 110, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "ZIPAIR", FlightNumber = "ZG 24", DepartureCity = "Manila", ArrivalCity = "Tokyo", DepartureTime = "09:45", ArrivalTime = "15:20", DepartureDate = flightDate(23), Price = 24000m, Class = "Economy", SeatsAvailable = 100, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                // ── Davao hub routes (Davao is the origin city of this agency) ──
                new Flight { Airline = "Philippine Airlines", FlightNumber = "PR 1801", DepartureCity = "Davao", ArrivalCity = "Manila", DepartureTime = "06:15", ArrivalTime = "07:55", DepartureDate = flightDate(7), Price = 4800m, Class = "Economy", SeatsAvailable = 90, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Cebu Pacific", FlightNumber = "5J 979", DepartureCity = "Davao", ArrivalCity = "Cebu", DepartureTime = "08:30", ArrivalTime = "09:40", DepartureDate = flightDate(9), Price = 3600m, Class = "Economy", SeatsAvailable = 100, ImageUrl = "https://images.unsplash.com/photo-1540339832862-474599807a5e?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Philippine Airlines", FlightNumber = "PR 2351", DepartureCity = "Davao", ArrivalCity = "Tokyo", DepartureTime = "19:20", ArrivalTime = "01:10", DepartureDate = flightDate(10), Price = 29500m, Class = "Economy", SeatsAvailable = 80, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Philippines AirAsia", FlightNumber = "Z2 522", DepartureCity = "Davao", ArrivalCity = "Singapore", DepartureTime = "13:05", ArrivalTime = "16:20", DepartureDate = flightDate(12), Price = 19800m, Class = "Economy", SeatsAvailable = 85, ImageUrl = "https://images.unsplash.com/photo-1558389186-4386d1bea007?w=800&q=80", Status = "Active" },
                new Flight { Airline = "Air Swift", FlightNumber = "DG 401", DepartureCity = "Davao", ArrivalCity = "Siargao", DepartureTime = "09:00", ArrivalTime = "10:20", DepartureDate = flightDate(13), Price = 4100m, Class = "Economy", SeatsAvailable = 45, ImageUrl = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80", Status = "Active" },
            });
            await db.SaveChangesAsync();
        }
